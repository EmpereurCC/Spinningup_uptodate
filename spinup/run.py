...
if __name__ == '__main__':
    ...
    valid_algos = ['vpg', 'trpo', 'ppo_pyco', 'ddpg', 'td3', 'sac', 'ppo_rgb', 'ppo_pyco', 'ppo','random_agent', 'ppo_pyco_multi','ppo_pyco_load','impala']
    ...
    if cmd in valid_help:
        ...
        special_info = dedent("""
            ...
            \tpython -m spinup.run ppo_pyco --env HalfCheetah-v2 --clip_ratio 0.1
...
#python -m spinup.run plot /home/clement/spinningup/data/cmd_ppo/cmd_ppo_s0


#Watch the trained agent with:

#python -m spinup.run test_policy /home/clement/spinningup/data/cmd_ppo/cmd_ppo_s0
