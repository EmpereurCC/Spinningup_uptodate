...
register(
    id='fluvial_natation-v0',
    entry_point='pycolab.examples.fluvial_natation-v0',
    reward_threshold=20,
)

register(
    id='warehouse_manager-v0',
    entry_point='pycolab.examples.warehouse_manager-v0',
    reward_threshold=200,
)

register(
    id='fluvial_natation-v1',
