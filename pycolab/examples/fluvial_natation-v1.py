...
# = is 61 and (576, 255, 0)
# , is 44 and (999, 999, 999)
# . is 46 and (999, 999, 999)
# ` is 96 and (999, 999, 999)
# ~ is 126 and (999, 999, 999)
# : is 58 and (999, 999, 999)
# P is 80 and (0, 999, 0)
#   is 32 and (0, 505, 999)
# this game is not very well suited for rgb as the comas and stuff can't be represented?

def make_game():
  """Builds and returns a Fluvial Natation game."""
  return ascii_art.ascii_art_to_game(
      GAME_ART3, what_lies_beneath=' ',
